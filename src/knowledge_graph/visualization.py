...
def get_networkx(json_dict, size_multipler=1.0):
    ...
    # event node
    event_list = ["assess", "bypass", "browse", "choose", "click", "complete", "collect", "connect", "copy", "decode", "deploy", "encode", "enter", "escalate", "initiate", "exploit", "extract", "fetch", "gain", "gather", "launch", "leave", "load", "modify", "obtain", "open", "select", "send", "simulate", "start", "steal", "trigger", "use", "write", "read", "communicate with", "communicate", "execute", "exfiltrate to", 'contain', 'install', 'compromise', 'deliver', 'execute on', 'establish', 'utilize', 'observe', 'download', 'create', 'detect', 'make', 'maintain', 'exfiltrate', 'attempt']
    event_idx = 0
    tactic_offset = 1000
